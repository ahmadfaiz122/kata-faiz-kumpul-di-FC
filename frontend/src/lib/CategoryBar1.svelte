        ...
        {#each categories as category}
            ...
            >
                ...
                >
                    ...
                    {:else if category.icon === 'technology'}
                        <svg
                            viewBox="0 0 80 80"
                            fill="none"
                            stroke="black"
                    ...
                    {:else if category.icon === 'business'}
                        <svg
                            viewBox="0 0 80 80"
                            fill="none"
                            stroke="black"
                    ...
                    {:else if category.icon === 'language'}
                        <svg
                            viewBox="0 0 80 80"
                            fill="none"
                            stroke="black"
